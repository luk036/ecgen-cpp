      ...
      public:
        ...
        auto yield_value(recursive_generator &generator) noexcept {
            struct awaitable {
                ...
                void await_suspend(
                    cppcoro::coroutine_handle<promise_type>) noexcept {}
        ...
        void destroy() noexcept {
            cppcoro::coroutine_handle<promise_type>::from_promise(*this)
                .destroy();
        }
        ...
        bool is_complete() noexcept {
            return cppcoro::coroutine_handle<promise_type>::from_promise(*this)
                .done();
        }
...
// Note: When applying fmap operator to a recursive_generator we just yield a

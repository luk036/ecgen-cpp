    ...
    class async_latch {
      public:
        ...
        async_latch(std::ptrdiff_t initialCount) noexcept
            : m_count(initialCount), m_event(initialCount <= 0) {}
        ...
        /// reaches zero. ie. when this method has been called at least
        /// 'initialCount' times.
        ///
        ...
        auto operator co_await() const noexcept { return m_event.operator co_await(); }

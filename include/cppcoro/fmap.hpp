    ...
    namespace detail {
        template <typename FUNC, typename AWAITABLE> class fmap_awaiter {
          ...
          public:
            ...
            decltype(auto) await_suspend(cppcoro::coroutine_handle<PROMISE> coro) noexcept(
            ...
            decltype(auto) await_resume() noexcept(
                noexcept(std::invoke(static_cast<FUNC &&>(m_func)))) {
        ...
        template <typename FUNC, typename AWAITABLE> class fmap_awaitable {
          ...
          public:
            template <
                ...
                std::enable_if_t<
                    std::is_constructible_v<
                        FUNC, FUNC_ARG &&> && std::is_constructible_v<AWAITABLE, AWAITABLE_ARG &&>,
                    int> = 0>
            ...
            auto operator co_await() && {
                return fmap_awaiter<FUNC &&, AWAITABLE &&>(static_cast<FUNC &&>(m_func),

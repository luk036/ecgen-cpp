...
namespace cppcoro {
    namespace detail {
        ...
        template <typename PROMISE> struct is_coroutine_handle<cppcoro::coroutine_handle<PROMISE>>
            : std::true_type {};
        ...
        template <typename T, typename = std::void_t<>> struct is_awaiter : std::false_type {};

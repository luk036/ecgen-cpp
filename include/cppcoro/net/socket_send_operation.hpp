...
class socket_send_operation_impl {
  public:
    socket_send_operation_impl(socket &s, const void *buffer,
...
class socket_send_operation
  ...
  public:
    socket_send_operation(socket &s, const void *buffer,
                          std::size_t byteCount) noexcept
...
class socket_send_operation_cancellable
  ...
  public:
    socket_send_operation_cancellable(socket &s, const void *buffer,

...
public:
  ...
  /// not it should immediately resume the coroutine on the current thread upon
  /// an operation completing synchronously or whether it should suspend the
  /// coroutine and wait until the I/O completion event is dispatched to an I/O
  /// thread.
  ...
  send_to(const ip_endpoint &destination, const void *buffer, std::size_t size,

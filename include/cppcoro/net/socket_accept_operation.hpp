...
public:
  socket_accept_operation_impl(socket &listeningSocket,
...
public:
  socket_accept_operation(socket &listeningSocket,
                          socket &acceptingSocket) noexcept
...
public:
  socket_accept_operation_cancellable(socket &listeningSocket,

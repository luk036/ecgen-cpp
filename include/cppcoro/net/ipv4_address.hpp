    ...
    class ipv4_address {
      ...
      public:
        ...
        explicit constexpr ipv4_address(std::uint32_t integer)
            : m_bytes{static_cast<std::uint8_t>(integer >> 24),
        ...
        explicit constexpr ipv4_address(std::uint8_t b0, std::uint8_t b1, std::uint8_t b2,
                                        std::uint8_t b3)
            : m_bytes{b0, b1, b2, b3} {}
        ...
        constexpr bool operator!=(ipv4_address other) const { return !(*this == other); }

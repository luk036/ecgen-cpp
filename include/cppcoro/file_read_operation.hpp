...
class file_read_operation
  ...
  public:
    file_read_operation(detail::win32::handle_t fileHandle,
...
class file_read_operation_cancellable
  ...
  public:
    file_read_operation_cancellable(
        detail::win32::handle_t fileHandle, std::uint64_t fileOffset,
        ...
        : cppcoro::detail::win32_overlapped_operation_cancellable<
              file_read_operation_cancellable>(fileOffset,

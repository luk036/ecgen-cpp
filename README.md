...
- Replace all occurrences of "ECGenCpp" in the relevant CMakeLists.txt with the name of your project
  - Capitalization matters here: `ECGenCpp` means the name of the project, while `ecgen` is used in file names.
...
./build/standalone/ECGenCpp --help
```
